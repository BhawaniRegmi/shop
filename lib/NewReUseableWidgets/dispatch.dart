//in below code cache is not getting use data is loading every time  from server without user refresh:
// import 'dart:convert';
...
//   bool _hasMoreData = true; // Add a flag to indicate more data availability
...
//   final SharedPreferences prefs = await SharedPreferences.getInstance();
//   prefs.setString('cachedOutFordelivery', json.encode(data));
// }
...
//   itemCount: _deliveryList.length + (_isLoading || !_hasMoreData ? 1 : 0),
//   itemBuilder: (context, index) {
//     if (index == _deliveryList.length) {
//       return !_hasMoreData
//           ? Center(child: Text("No more data available"))
